...
% Last Modified by GUIDE v2.5 02-Jan-2018 11:26:19
...
if now_image ==0
    ...
    set(handles.edit15,'String',num2str(io.p.otsu.thre_value));
    set(handles.edit13,'String',num2str(io.p.otsu.gauss_size));
    set(handles.edit14,'String',num2str(io.p.otsu.gauss_sigma));
    set(handles.edit16,'String',num2str(io.p.otsu.imsharpen_radius));
    set(handles.edit17,'String',num2str(io.p.otsu.imsharpen_amount));
    set(handles.edit18,'String',num2str(io.p.otsu.winer));
    set(handles.edit19,'String',num2str(io.p.otsu.deconv_len));
    set(handles.edit32,'String',num2str(io.p.otsu.deconv_theta));
    set(handles.edit33,'String',num2str(io.p.otsu.deconv_nsr));
    
    set(handles.edit21,'String',num2str(io.p.ds.alpha));
    set(handles.edit22,'String',num2str(io.p.ds.beta));
    set(handles.edit23,'String',num2str(io.p.ds.gamma));
    set(handles.edit24,'String',num2str(io.p.ds.epsilon));
    set(handles.edit25,'String',num2str(io.p.ds.delta));
    set(handles.edit26,'String',num2str(io.p.ds.sigmagradient));
    set(handles.edit27,'String',num2str(io.p.ds.diffuse_iterations));
    set(handles.edit28,'String',num2str(io.p.ds.kappa1));
    set(handles.edit29,'String',num2str(io.p.ds.kappa2));
    set(handles.edit30,'String',num2str(io.p.ds.gauss_filter_siz));
    set(handles.edit31,'String',num2str(io.p.ds.gauss_filter_fit));    
    
    A=io.p.id.wavelet_scale;
    if size(A,2)>1
        A_nam='';
        for ii=1:size(A,2)-1
            A_nam = [A_nam num2str(A(1,ii)) ','];
        end
        A_nam = [A_nam num2str(A(1,ii)) ''];
    else
        A_nam=num2str(A);
    end
    set(handles.edit12,'String',A_nam);
    set(handles.edit34,'String',num2str(io.p.id.radius));

    handles.sm_method = io.p.id.seg_method;
    if isempty(find(handles.sm_method==1))==0
        set(handles.checkbox1,'Value',1);
    else
        set(handles.checkbox1,'Value',0);
    end
    if isempty(find(handles.sm_method==2))==0
        set(handles.checkbox2,'Value',1);
    else
        set(handles.checkbox2,'Value',0);
    end
    if isempty(find(handles.sm_method==3))==0
        set(handles.checkbox3,'Value',1);
    else
        set(handles.checkbox3,'Value',0);
    end
    if isempty(find(handles.sm_method==4))==0
        set(handles.checkbox8,'Value',1);
    else
        set(handles.checkbox8,'Value',0);
    end    
    set(handles.checkbox4,'Value',io.p.id.wavelet_on);
    set(handles.checkbox9,'Value',io.p.otsu.otsu_on);
    ...
    set(handles.edit15,'String',num2str(p.otsu.thre_value));
    set(handles.edit13,'String',num2str(p.otsu.gauss_size));
    set(handles.edit14,'String',num2str(p.otsu.gauss_sigma));
    set(handles.edit16,'String',num2str(p.otsu.imsharpen_radius));
    set(handles.edit17,'String',num2str(p.otsu.imsharpen_amount));
    set(handles.edit18,'String',num2str(p.otsu.winer));
    set(handles.edit19,'String',num2str(p.otsu.deconv_len));
    set(handles.edit32,'String',num2str(p.otsu.deconv_theta));
    set(handles.edit33,'String',num2str(p.otsu.deconv_nsr));
    
    set(handles.edit21,'String',num2str(p.ds.alpha));
    set(handles.edit22,'String',num2str(p.ds.beta));
    set(handles.edit23,'String',num2str(p.ds.gamma));
    set(handles.edit24,'String',num2str(p.ds.epsilon));
    set(handles.edit25,'String',num2str(p.ds.delta));
    set(handles.edit26,'String',num2str(p.ds.sigmagradient));
    set(handles.edit27,'String',num2str(p.ds.diffuse_iterations));
    set(handles.edit28,'String',num2str(p.ds.kappa1));
    set(handles.edit29,'String',num2str(p.ds.kappa2));
    set(handles.edit30,'String',num2str(p.ds.gauss_filter_siz));
    set(handles.edit31,'String',num2str(p.ds.gauss_filter_fit));  
    
    A=p.id.wavelet_scale;
    if size(A,2)>1
        A_nam='''[';
        for ii=1:size(A,2)-1
            A_nam = [A_nam num2str(A(1,ii)) ','];
    ...
    set(handles.edit12,'String',A_nam);
    set(handles.edit34,'String',num2str(p.id.radius));
    
    handles.sm_method = p.id.seg_method;
    if isempty(find(handles.sm_method==1))==0
        set(handles.checkbox1,'Value',1);
    else
        set(handles.checkbox1,'Value',0);
    ...
    set(handles.checkbox4,'Value',p.id.wavelet_on);
    set(handles.checkbox9,'Value',p.otsu.otsu_on);
...
if now_image ==0
    ...
    p.id.radius=str2double(get(handles.edit34,'String'));
    p.id.xy_length = p.id.radius/io.resolution_xy;
    p.id.z_length = p.id.radius/io.resolution_z;
    est_wlet = p.id.xy_length*0.26;
    ...
    if p.id.wavelet_on ==1
        ...
        if isempty(find(A==','))==0
            ...
            p.id.wavelet_scale=C;
        else
            p.id.wavelet_scale = str2double(A);
        end
    end  
