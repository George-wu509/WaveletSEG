function varargout = run4_parameters(varargin)
...
% Last Modified by GUIDE v2.5 10-May-2018 12:25:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @run4_parameters_OpeningFcn, ...
                   'gui_OutputFcn',  @run4_parameters_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function varargout = run4_parameters_OutputFcn(hObject, eventdata, handles) 
...
xyr = round((max(nucle_coordination(:,3))-min(nucle_coordination(:,3))+max(nucle_coordination(:,2))-min(nucle_coordination(:,2)))/4);
handles.p=p;
handles.p2=p;

set(handles.edit4,'String',xyr);
set(handles.edit5,'String',xyr);
set(handles.edit7,'String',round(max(nucle_coordination(:,4))));
set(handles.edit8,'String',p.prof_dense);
set(handles.checkbox10,'Value',p.display_figures);
set(handles.checkbox11,'Value',p.save_figures);

set(handles.checkbox12,'Value',p.proj_nucleiN);
set(handles.checkbox13,'Value',p.proj_chal);
set(handles.checkbox14,'Value',p.proj_depth);
set(handles.checkbox15,'Value',p.proj_size);
set(handles.checkbox16,'Value',p.proj_neighbor);
set(handles.checkbox17,'Value',p.proj_density);
set(handles.checkbox18,'Value',p.proj_shape);
...
function run4_parameters_OpeningFcn(hObject, eventdata, handles, varargin)
...
p = handles.p;
set(handles.edit4,'String',p.prof_Lx);
set(handles.edit5,'String',p.prof_Ly);
set(handles.edit7,'String',p.prof_Lz);
set(handles.edit8,'String',p.prof_dense);
set(handles.checkbox10,'Value',p.display_figures);
set(handles.checkbox11,'Value',p.save_figures);
...
for i=1:size(imagename,2)
    ...
    p.prof_Lx = str2num(get(handles.edit4,'String'));
    p.prof_Ly = str2num(get(handles.edit5,'String'));
    p.prof_Lz = str2num(get(handles.edit7,'String'));
    p.prof_dense = str2num(get(handles.edit8,'String'));
    p.display_figures = get(handles.checkbox10,'Value');
    p.save_figures = get(handles.checkbox11,'Value');

    p.proj_nucleiN = get(handles.checkbox12,'Value');
    p.proj_chal = get(handles.checkbox13,'Value');
    p.proj_depth = get(handles.checkbox14,'Value');
    p.proj_size = get(handles.checkbox15,'Value');
    p.proj_neighbor = get(handles.checkbox16,'Value');
    p.proj_density = get(handles.checkbox17,'Value');
    p.proj_shape = get(handles.checkbox18,'Value');
